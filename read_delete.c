...
void delete_file(Fat12Entry *entry, FILE *in, int start_file) {
...
int main() {
    ...
    for(i=0; i<bs.root_dir_entries; i++) {
        ...
        //Que sea archivo y que no se haya borrado antes
        if(entry.attributes[0] == 0x20 && entry.filename[0] != 0xE5) {
